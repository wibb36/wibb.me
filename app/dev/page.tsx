    ...
    return (
        <>
            <section className="max-w-[702px]">
                ...
                <p className="my-5 text-neutral-800 dark:text-neutral-200">Today, I make web and mobile applications with Next.js and Expo</p>

                <div className="flex flex-col space-y-4 mt-8">
                    <h3 className="my-1 max-w-[702px] font-extrabold text-xl md:text-2xl text-neutral-800 dark:text-neutral-200">A little history...</h3>
                    <p className="my-5 text-neutral-800 dark:text-neutral-200">A few facts when I look back on my dev experience. I'll probably update it more over time</p>
                </div>
