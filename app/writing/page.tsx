    ...
    return (
        <>
            <section className="mb-6">
                <H1>Writing</H1>
                <h2 className="my-5 max-w-[702px] text-gray-800 dark:text-gray-200">
                ...
                <p className="text-gray-600">Soon, I will transfer all the articles from my old website to this new one.</p>
            </section>
