...
A style guide is an essential tool for creating a consistent visual identity that reflects your brand's personality and values. While not always publicly available, nearly every prominent brand has its own style guide. For example, Google's style guide is available [here](https://google.github.io/styleguide/).
...
<Image
    ...
    src={`/static/writing/style-guides-component-libraries-design-systems/button.webp`}
    width={821}
    height={154}
/>
